...
namespace MapsXF
{
    public class OfflineMapSettingsViewModel : BaseViewModel
    {
        ...
        {
            var res = await ShowConfirmAsync("Gen_Sure_Remove_All_Offline_Map", "Gen_Downloaded_Maps");
        ...
        public ICommand DeleteMapCommand => deleteMapCommand ?? (deleteMapCommand = new Command(async (param) =>
        {
            ...
            var res = await ShowConfirmAsync("Gen_Sure_Remove_Offline_Map", "Gen_Downloaded_Maps");
